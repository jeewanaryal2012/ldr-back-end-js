...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["components-register-register-module"], {
  ...
  function srcAppComponentsRegisterRegisterComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    RegisterComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      decls: 38,
      vars: 3,
      consts: [[1, "login-form-wrapper", "container", "container-fluid"], [1, "row"], [1, "col-md-12"], ["formGroup", "loginForm", 1, "login-form"], [1, "form-group"], ["appearance", "outline", 1, "col-md-12"], ["matInput", "", "placeholder", "Placeholder", "formControlName", "firstName", "autocomplete", "off"], ["matInput", "", "placeholder", "Placeholder", "formControlName", "lastName", "autocomplete", "off"], ["matInput", "", "placeholder", "Placeholder", "formControlName", "email", "autocomplete", "off"], ["type", "password", "matInput", "", "placeholder", "Placeholder", "formControlName", "password"], ["matInput", "", "placeholder", "Placeholder", "formControlName", "repeatPassword", "autocomplete", "off"], [1, "form-group", "p-3"], [1, "btn", "btn-link", 3, "disabled", "click"], ["class", "spinner-border spinner-border-sm mr-1", 4, "ngIf"], [1, "btn", "btn-link", 3, "disabled"], ["routerLink", "/login", "routerLinkActive", ""], [1, "spinner-border", "spinner-border-sm", "mr-1"]],
  ...
  function srcAppComponentsRegisterRegisterModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    RegisterModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
      ...
      imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_1__["CommonModule"], _register_routing_module__WEBPACK_IMPORTED_MODULE_2__["RegisterRoutingModule"], _angular_material_form_field__WEBPACK_IMPORTED_MODULE_4__["MatFormFieldModule"], _angular_material_input__WEBPACK_IMPORTED_MODULE_5__["MatInputModule"]]]
    });
