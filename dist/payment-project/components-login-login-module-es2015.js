...
LoginComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: LoginComponent, selectors: [["app-login"]], decls: 23, vars: 4, consts: [[1, "login-form-wrapper", "container", "container-fluid"], [1, "row"], [1, "col-md-12"], [1, "login-form", 3, "formGroup"], [1, "form-group"], ["appearance", "outline", 1, "col-md-12"], ["matInput", "", "placeholder", "Placeholder", "formControlName", "userName", "autocomplete", "off"], ["type", "password", "matInput", "", "placeholder", "Placeholder", "formControlName", "password"], [1, "form-group", "p-3"], [1, "btn", "btn-link", 3, "disabled", "click"], ["class", "spinner-border spinner-border-sm mr-1", 4, "ngIf"], [1, "btn", "btn-link", 3, "disabled"], ["routerLink", "/register", "routerLinkActive", ""], [1, "spinner-border", "spinner-border-sm", "mr-1"]], template: function LoginComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function LoginComponent_Template_button_click_17_listener($event) { return ctx.onSubmit($event); });
...
/* harmony import */ var _login_routing_module__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./login-routing.module */ "./src/app/components/login/login-routing.module.ts");
